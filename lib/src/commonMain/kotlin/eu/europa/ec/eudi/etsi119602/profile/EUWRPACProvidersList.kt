...
public object EUWRPACProvidersList : ListOfTrustedEntitiesProfile {
    override val name: String get() = ETSI19602.EU_WRPAC_LOTE
    override val scheme: Scheme get() = Scheme.EXPLICIT
    override val statusDeterminationApproach: String get() = ETSI19602.EU_WRPAC_STATUS_DETERMINATION_APPROACH
    override val schemeCommunityRules: List<MultiLanguageURI>
        get() = listOf(
            MultiLanguageURI(Language.ENGLISH, URIValue(ETSI19602.EU_WRPAC_SCHEME_COMMUNITY_RULES)),
        )
